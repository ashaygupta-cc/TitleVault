          ...
          <Card className="bg-gradient-to-br from-card to-muted/20 border-border/50">
            <CardContent className="p-4">
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h1 className="text-xl font-bold text-foreground">{getMeta('survey_no') || getMeta('surveyNo') || record.metadata?.survey_number|| 'Parcel'}</h1>
            ...
            <TabsContent value="summary" className="mt-4 space-y-4">
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  {[
                    { label: 'Survey Number', value: details?.survey_number || getMeta('survey_no') || getMeta('surveyNo') || record.metadata?.survey_number },
